...
const MODULE_CATALOG = [
  ...
  { key: 'banners',       label: 'Banners',           desc: 'Carrusel de imágenes en el catálogo',  tier: 'free', icon: ImageIcon   },
  { key: 'product_page',  label: 'Página de producto', desc: 'Detalle extendido e interno por producto', tier: 'free', icon: FileText   },
  { key: 'categories',    label: 'Categorías',         desc: 'Filtros de categoría en el catálogo',     tier: 'free', icon: Tag         },
  ...
  { key: 'social',        label: 'Redes sociales',     desc: 'Links en el footer del catálogo',          tier: 'free', icon: Share2      },
    ...
    return (
      <div className="p-5 pb-10 space-y-4 max-w-3xl mx-auto">
        <div className="flex gap-3 rounded-xl border border-info/20 bg-info/10 p-3 text-info">
          ...
          <p className="text-xs">Estos banners se muestran en el carrusel de tu catálogo público. Se muestran en el orden indicado.</p>
        </div>
